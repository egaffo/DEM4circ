...
source_dataset_qs <- file.path(params$outdir, "IDC_trimmed_source_dataset.qs")
simulated_datasets_qs <- file.path(params$outdir, "IDC_trimmed_simulated_datasets.qs")
```
